...
import com.emigo.app.data.remote.dto.FriendAcceptBody
...
interface EmberApi {
    ...
    @POST("friends/{friendshipId}/streak/restore")
    suspend fun restoreStreak(@Path("friendshipId") friendshipId: String): Response<FriendSummaryDto>
