...
fun FriendProfileScreen(
    ...
    Column(
        ...
        Box(modifier = Modifier.fillMaxWidth().padding(bottom = 16.dp), contentAlignment = Alignment.Center) {
            GlowPhotoTile(size = 150.dp, seed = friend.friendId.hashCode(), photoUrl = friend.profilePhotoUrl)
        }
        ...
        Row(
            ...
            Icon(Icons.Filled.LocalFireDepartment, contentDescription = null, tint = colors.glow, modifier = Modifier.size(16.dp))
            Text(
